...
{
	string upperCase1 = word1;
	std::transform(upperCase1.begin(), upperCase1.end(), upperCase1.begin(), ::toupper);
	auto lookup1 = dict.find(upperCase1);

	string upperCase2 = word2;
	std::transform(upperCase2.begin(), upperCase2.end(), upperCase2.begin(), ::toupper);
	auto lookup2 = dict.find(upperCase2);
